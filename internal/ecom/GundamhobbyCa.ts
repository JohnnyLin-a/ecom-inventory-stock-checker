...
class GundamhobbyCa extends Ecom {
    static get REQUEST_HEADER(): AxiosRequestHeaders { return {
    ...
    async execute(): Promise<Item[]> {
        ...
        while(typeof nextUrl !== 'undefined') {
            ...
            let response = await axios.get(nextUrl, { headers: GundamhobbyCa.REQUEST_HEADER})
            ...
            $("main>div.grid>div.grid__item>div.grid_uniform>div.grid__item").each((i, elem) => {
                console.log(i)
